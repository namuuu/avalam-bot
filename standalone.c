...
int main(int argc, char * argv[]) {
	...
	setBonus(p, &p.evolution.bonusJ, JArienU, -1);
...
/* DESCRIPTION :La fonction a pour principe de concaner les arguments dans le cas il y a présence de plusieurs à cause des espaces en trop        */
/* Retourne :Rien         			   */
...
/* DESCRIPTION :la fonction demande la position des bonus et produit une boucle infini tant que la position donné                                             */
